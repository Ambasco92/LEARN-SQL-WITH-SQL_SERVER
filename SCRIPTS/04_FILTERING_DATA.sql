...
-- Retrieve all customers with score a 500 or more
SELECT *
FROM customers
WHERE score >= 500;
...
-- Retrieve all customers NOT from either UK or the USA.
SELECT *
FROM customers
...
-- Find all customers whose first name has 'r' in the fourth position.
SELECT *
FROM customers
