...
-- select customer_id and sales from orders table
SELECT customer_id, sales
FROM orders;


-- select first_name, country, and score from customers table
...
-- Retrieve first_name, country of customers from Germany
...
/* Retrive all customers and sort the results by the country
...
/* Find the total score and the total number of customers from each country */
SELECT 
	country,
...
-- Retrieve only 2 customers with the lowest scores
SELECT TOP 2 *
FROM customers
ORDER BY score ASC;
